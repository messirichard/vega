...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#7d7d7d'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '30px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '30px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#212121'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '28px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#212121'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '26px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#292929'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#313131'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '40px', 'lineheight' => '40px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#313131'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Archivo Narrow', 'style' => 'bold', 'character'  => 'latin', 'color' => '#303336'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#343434'));
