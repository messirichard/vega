...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More <a rel="nofollow" href="http://www.templatemonster.com/category.php?category=129&type=17" target="_blank">Investment Company Templates at TemplateMonster.com</a>
	<?php } ?>
</div>